...
while(True):
    ...
    print("------------------------ Added at : "+datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")+"------------------------")
    time.sleep(10)  # 10 seconds.
    print("hi")  #to print the id of the records added in the collection(for debugging, this value can be observed in the heroku logs)
